          ...
          builder: (context, snapshot) {
            return Scaffold(
              appBar: AppBar(
                ...
                elevation: 0,
                actions: [
                  IconButton(onPressed: () => _confirmSignOut(context), icon: Icon(Icons.logout), color: Color.fromRGBO(61, 99, 102, 1),),
                  SizedBox(width: 10,)
                ],
              ),
                    ...
                    child: Column(
                      ...
                      children: [
                        AnimatedTextKit(
                          animatedTexts: [
                            TyperAnimatedText(
                              person.displayName.length > 15 ? 'Hello ${person.displayName.substring(0, person.displayName.lastIndexOf(" "))}'
                        ...
                        data.single.specialty == null || data.single.specialty.length < 3 ?
                        DelayedDisplay(
                            delay: Duration(milliseconds: 2700),
                            child: Text('Please complete your profile', style: TextStyle(color:Colors.deepOrangeAccent),)): Container(),
                      ],
                    ),
                    height: 270,
                  ),
                          ...
                          children:  [
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.all(Radius.circular(20)),
                                        color: Color.fromRGBO(61, 99, 102, 0.9)
                                    ),
                            ...
                            Material(
                              child: InkWell(
                                borderRadius : BorderRadius.all(Radius.circular(20)),
                                onTap: (){
                                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Colleague(regUser: data.single,)));
                                  setState(() {
                                    collName = null;
                                    date = null;
                                  });
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.all(Radius.circular(20)),
                                          color: Color.fromRGBO(92, 150, 156, 0.9)
                                        ),
                                        padding: EdgeInsets.only(bottom:20.0),
                                        child: GridTile(
                                          footer: Text(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.all(Radius.circular(20)),
                                          color:Color.fromRGBO(77, 116, 99, 0.9),
                                      ),
                                      padding: EdgeInsets.only(bottom:20.0),
                                      child: GridTile(
                                        footer: Text(
                                  ...
                                  Positioned(
                                      right: 0,
                                      top: 0,
                                      child:  date != null  && collName == null ? Container(
                                          constraints: BoxConstraints(
                                            minWidth: 12,
                                            minHeight: 12,),
                                          padding: EdgeInsets.all(6),
                              ...
                              child: InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.all(Radius.circular(20)),
                                        color: Color.fromRGBO(77, 118, 154, 0.9)
                                    ),
                                    padding: EdgeInsets.only(bottom:20.0),
                                    child: GridTile(
                                      footer: Text(
