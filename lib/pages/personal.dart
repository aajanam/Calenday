  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RegUser>>(
        ...
        builder: (context, snapshot) {
          if (snapshot
              .hasData /*&& snapshot.data.single.uid == Auth().currentUser.uid*/) {
            return Scaffold(
              appBar: AppBar(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            initialValue: widget.person.specialty != null
                                ? widget.person.specialty
                                : '',
                            onSaved: (val) {
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                hintText:
                                    'Please provide your first work place info',
                                hintStyle: TextStyle(
                                    color: Color.fromRGBO(160, 160, 160, 1)),
                                border: enabled
                                    ? UnderlineInputBorder(
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                hintText:
                                    '(Optional) provide your second work place)',
                                hintStyle: TextStyle(
                                    color: Color.fromRGBO(160, 160, 160, 1)),
                                border: enabled
                                    ? UnderlineInputBorder(
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                hintText:
                                    '(Optional) provide your third work place',
                                hintStyle: TextStyle(
                                    color: Color.fromRGBO(160, 160, 160, 1)),
                                border: enabled
                                    ? UnderlineInputBorder(
                              ...
                              ElevatedButton(
                                ...
                                onPressed: enabled == true
                                    ? () {
                                        ...
                                        setState(() {
                                          person.getPlayerId().whenComplete(
                                              () => person.deviceToken =
                                                  deviceToken);
                                        });
                                        person.setUser();
