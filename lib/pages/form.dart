...
class _EventFormState extends State<EventForm> {
  ...
  void initState() {
    ...
    if (widget.event != null) {
      ...
      selDate = DateTime(
          DateTime.parse(widget.event.date).year,
          DateTime.parse(widget.event.date).month,
          DateTime.parse(widget.event.date).day);
      dateController.text = formatDate(
          DateTime.parse(widget.event.date), ['dd', ' ', 'M', ' ', 'yyyy']);
      ...
      participants = [
        {'id': Auth().currentUser.uid, 'notifyStat': true, 'hour': option}
      ];
    ...
    return Stack(children: [
      StreamBuilder<List<RegUser>>(
          ...
          builder: (context, snap) {
            if (snap.hasData) {
              var owner = snap.data.firstWhereOrNull(
                  (element) => element.uid == event.creatorId);
              suggestions = [
                owner.workPlace1,
                owner.workPlace2,
                owner.workPlace3
              ...
              return Scaffold(
                bottomNavigationBar: Consumer<NotificationService>(
                  builder: (context, model, _) {
                    return Padding(
                      padding:
                          const EdgeInsets.only(top: 8.0, bottom: 8, left: 35),
                      child: Column(
                        ...
                        children: [
                                          ...
                                          if (_formKey.currentState
                                            ...
                                            if (selDate
                                              ...
                                              showAlertDialog(context,
                                                  title:
                                                      "Unable to save unfinished event",
                                                  content:
                                                      'The time has passed. '
                                                      'Please change the date or start hour before saving" ',
                                            ...
                                            if (widget.event != null &&
                                                images.length > 0) {
                                              if (widget.event.imageUrl ==
                                                  null) {
                                                event.changeImageUrl =
                                                    await saveImage();
                                              } else {
                                                event.imageUrl
                                                    .addAll(await saveImage());
                                                event.changeImageUrl =
                                            ...
                                            if (widget.event == null &&
                                              ...
                                              sendMessageToParticipants(event,
                                                  snap, owner, 'invites you');
                                              await showAlertDialog(context,
                                                  title: 'Reminder Set Up ',
                                                  content:
                                                      'Reminder has been set automatically to 2 hours before. Tap on event to change reminder.',
                                                  defaultActionText: 'OK');
                                            } else if (widget.event == null &&
                                                selDate
                                                    .add(Duration(
                                              ...
                                              await event.saveEvent();
                                              sendNotif(
                                                  model, event, 'Tomorrow');
                                              sendMessageToParticipants(event,
                                                  snap, owner, 'invites you');
                                              await showAlertDialog(context,
                                                  title: 'Reminder Set Up ',
                                                  content:
                                                      'Reminder has been set automatically to 1 day before. Tap on event to change reminder.',
                                                  defaultActionText: 'OK');
                                            } else if (widget.event == null &&
                                                selDate
                                                    .add(Duration(
                          ...
                          widget.event != null
                              ? Text(
                                  isDone == false
                                      ? 'Created on: ${formatDate(DateTime.parse(event.created.toDate().toIso8601String()), [
                                              d,
                                              ' ',
                                              M,
                                              ' ',
                                      ...
                                      : 'Done on: ${formatDate(DateTime.parse(event.created.toDate().toIso8601String()), [
                                              d,
                                              ' ',
                                              M,
                                              ' ',
                ...
                appBar: AppBar(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        owner.displayName.length > 15
                                            ? owner?.displayName?.substring(
                                                0,
                                                owner?.displayName
                                                    ?.lastIndexOf(' '))
                                            : owner?.displayName,
                  ...
                  elevation: 0,
                  actions: [
                    if (widget.event != null && participants.length > 1)
                      IconButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) =>
                                    DiscussPage(event: widget.event)));
                          }),
                    SizedBox(
                      width: 8,
                    ),
                    ...
                    widget.event != null &&
                            selDate
                                ...
                                .isAfter(DateTime.now().add(Duration(hours: 2)))
                ...
                body: StreamBuilder<List<Events>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      getTimeList(snapshot, bookTimeOTAll, availableTimeAll,
                          selDate, today);
                              ...
                              child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                            ...
                                                            : () async {
                                                                ...
                                                                if (picked !=
                                                                  ...
                                                                  if (!picked
                                                                    ...
                                                                    model.cancelNotification(event
                                                                        .eventId
                                                                        .hashCode);
                                                                  } else {
                                                                    showAlertDialog(
                                                                        ...
                                                                        title:
                                                                            'Invalid date',
                                                                        content:
                                                                            'Please choose today\'s date or after',
                                                                        defaultActionText:
                                                                            'OK');
                                                                  }
                                                                }
                                    ...
                                    SizedBox(
                                      height: 2,
                                    ), // Space between date row & time row
                                    ...
                                    images.length > 0 ||
                                            widget.event != null &&
                                                widget.event.imageUrl != null &&
                                                widget.event.imageUrl.length > 0
                                        ? Padding(
                                                      ...
                                                      widget.event != null &&
                                                          widget.event
                                                              ...
                                                              Auth()
                                                                  .currentUser
                                                                  .uid
                                                  ? 'Tap to view, Double Tap to remove it'
                                                  : 'Tap to view',
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      160, 160, 160, 1),
                                    ...
                                    widget.event != null &&
                                        ...
                                        ? Padding(
                                            padding: const EdgeInsets.only(
                                                left: 2.0, top: 0),
                                            child: SizedBox(
                                              height: event.imageUrl.length > 3
                                                  ? 225
                                                  : 122,
                                              child: buildFirebaseGridView(
                                                  event.imageUrl),
                                            ),
                                          )
                                        : Container(),
  ...
  void sendMessageToParticipants(EventProvider event,
      AsyncSnapshot<List<RegUser>> snapshot, RegUser owner, String action) {
    ...
    for (var playId in playIds) {
      if (playId != null) {
        sendMessage(
            playId,
            '${owner.displayName} $action',
            '${dateController.text}: ${_procedureController.text} at ${_placeController.text}',
            selDate.toString(),
            '$startHour');
      }
    }
  ...
  void sendNotif(
      NotificationService model, EventProvider event, String when) async {
    if (event.startHour >= 10) {
      await model.zonedScheduleNotification(
          event.eventId.hashCode,
          '$when - ${formatDate(DateTime.parse(selDate.toString()), [
                'dd',
                ' ',
                'M',
                ' ',
                'yyyy',
                ' at ${event.startHour}:00'
              ])}',
  ...
  void savingBookTime(EventProvider event) {
    ...
    for (var i = 0; i < endHour - startHour; i++) {
      bookTimeOT.add(startHour + i);
    }
    event.changeBookTime = bookTimeOT;
  }

  void getTimeList(AsyncSnapshot<List<Events>> snap, List<int> booked,
      List<int> availableTime, DateTime date, DateTime today) {
    var timeNow = TimeOfDay.fromDateTime(DateTime.now()).hour;
    if (snap.hasData) {
      var mySched = snap.data.where((element) => element.participants
          .map((e) => e['id'])
          .contains(Auth().currentUser.uid));
      var daySched =
          mySched.where((element) => DateTime.parse(element.date) == date);
      if (date == today) {
  ...
  Future<void> _confirmDelete(BuildContext context, NotificationService model,
      AsyncSnapshot<List<RegUser>> snapshot, RegUser owner) async {
    final event = Provider.of<EventProvider>(context, listen: false);
        ...
        children: /* widget.event == null || widget.event.imageUrl.length == 0 ?*/
          ...
          return GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                    border:
                        Border.all(color: Color.fromRGBO(198, 198, 198, 1))),
                child: AssetThumb(
    ...
    return GridView.count(
      ...
      children: List.generate(urls.length, (index) {
        ...
        return GestureDetector(
            ...
            onDoubleTap: widget.event != null &&
                    widget.event.creatorId == Auth().currentUser.uid
                ? () {
  ...
  Future<void> loadAssets() async {
    ...
    try {
      resultList = await MultiImagePicker.pickImages(
        maxImages: widget.event != null && widget.event.imageUrl != null
            ? 6 - widget.event.imageUrl.length
            : 6,
        enableCamera: true,
              ...
              DropdownButton<String>(
                  ...
                  hint: Text(
                      ...
                      style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w600,
                          color: selDate.isBefore(today) ||
                                  !availableTimeAll.contains(startHour)
                              ? Colors.pinkAccent
                              : Colors.white)),
                  items: event != null &&
                              event.creatorId == Auth().currentUser.uid &&
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'End Hour',
                  style: TextStyle(
                      fontSize: 12, color: Color.fromRGBO(164, 164, 164, 1)),
                ),
              ),
              SizedBox(
                width: 10,
              ...
              DropdownButton<String>(
                ...
                items: event != null &&
                    ...
                    ? endTime
                        .map(
                          (value) => DropdownMenuItem<String>(
                            child: Text(value > 9 ? '$value:00' : '0$value:00'),
                            value: value.toString(),
                          ),
                        )
                        .toList()
  ...
  void getEndTime(String starHour) {
    for (var i = int.parse(starHour); i < i + 6; i++) {
      if (availableTimeAll.contains(i)) {
        endTime.add(i);
      } else
        break;
    }
